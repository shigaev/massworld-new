...
<head>
    ...
    <title><?php bloginfo(); ?> | <?php bloginfo( 'description' ); ?> | <?php single_cat_title(); ?></title>
    <!-- Google tag (gtag.js) -->
				...
				<?php else: ?>
                    <a class="nav-logo__link" href="">
                        <img class="nav-logo__img"
                             src="<?php echo get_template_directory_uri() . '/assets/img/logo.svg' ?>" alt="">
                    </a>
				<?php endif; ?>
            </div>
